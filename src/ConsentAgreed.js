...
class ConsentAgreed extends React.Component{
	...
	render() {
		 ...
		 <Row>
			<Col sm>
			<Card>
			  <Card.Header><b>Thank you for Agreeing to Participate in the Study</b></Card.Header>
			  <Card.Body>
				<Card.Text>
				<Alert variant="info"> Next steps: (1) Learn Rush Hour and (2) Take the survey </Alert>
				...
				<br/>
				<i>I have read the information stated and willingly signed the consent form.</i><br/>
				</Card.Text>
			  </Card.Body>
			</Card>
			</Col>		
